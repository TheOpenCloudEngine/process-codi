...
CREATE  TABLE IF NOT EXISTS `uengine`.`comtable` (
  ...
  `COMNAME` VARCHAR(30) NULL DEFAULT NULL ,
  `DESCRIPTION` VARCHAR(255) NULL DEFAULT NULL ,
...
INSERT INTO `emptable` (`empcode`, `EMPNAME`, `PASSWORD`, `ISADMIN`, `EMAIL`,`GLOBALCOM`, `ISDELETED`, `LOCALE`, `approved`, `guest`) VALUES ('2', 'Member', 'member', '1', 'member@uengine.org', '1', '0', 'ko', '1', '0');
